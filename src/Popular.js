          ...
          <div className="row">
                  ...
                  <h2 className="section-heading">Popular Restaurants:<br/></h2>
                        <div className="col-6 col-lg-4">
                                  ...
                                  <img className="img-responsive1" src="src/Dialogue-in-the-Dark.jpg" alt="" width="320px" height="200px" />
                          </div>
                          <div className="col-6 col-lg-4">
                                    <div className="clearfix"></div>
                                    <h4>Olivo Bistro</h4>
                                    ...
                                    <img className="img-responsive1" src="src/Olivo.jpg" alt="" width="320px" height="200px" /><br/>
                            </div>
                            <div className="col-6 col-lg-4">
                                      <div className="clearfix"></div>
                                      ...
                                      <img className="img-responsive1" src="src/kabita.jpg" alt="" width="320px" height="200px" />
                              </div>
          </div>
     </div>
  </div>
      ...
      <div className="container">
          <div className="row">
                        ...
                        <div className="col-6 col-lg-4">
                                  ...
                                  <img className="img-responsive1" src="src/barb.jpeg" alt="" width="320px" height="200px" />
                          </div>
                          <div className="col-6 col-lg-4">
                                    <div className="clearfix"></div>
                                    ...
                                    <img className="img-responsive1" src="src/nijam.jpg" alt="" width="320px" height="200px" /><br/>
                            </div>
                            <div className="col-6 col-lg-4">
                                      <div className="clearfix"></div>
                                      ...
                                      <img className="img-responsive1" src="src/deccan.jpg" alt="" width="320px" height="200px" />
                              </div>
          </div>
     </div>
  </div>
